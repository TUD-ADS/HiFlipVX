...
void swTestColorConversion(void) {
	...
	for (vx_uint32 k = 0; k < 2; k++) {
		...
		if (k == 0) {
			...
			ImgConvertColor<vx_uint8, vx_uint32, MATRIX_SIZE, MATRIX_SIZE, VX_DF_IMAGE_U8, VX_DF_IMAGE_RGBX>(src_a, dst_a);
		}
		if (k == 1) {
			printf("Color Conversion Grayscale to RGB:\n");
			ImgConvertColor<vx_uint8, vx_uint32, MATRIX_SIZE, MATRIX_SIZE, VX_DF_IMAGE_U8, VX_DF_IMAGE_RGB>(src_a, dst_a);
		}
	...
	for (vx_uint32 k = 0; k < 2; k++) {
		...
		if (k == 0) {
			...
			ImgConvertColor<vx_uint32, vx_uint8, MATRIX_SIZE, MATRIX_SIZE, VX_DF_IMAGE_RGBX, VX_DF_IMAGE_U8>(src_b, dst_b);
		}
		if (k == 1) {
			printf("Color Conversion RGB to Grayscale:\n");
			ImgConvertColor<vx_uint32, vx_uint8, MATRIX_SIZE, MATRIX_SIZE, VX_DF_IMAGE_RGB, VX_DF_IMAGE_U8>(src_b, dst_b);
		}
